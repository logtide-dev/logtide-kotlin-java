...
- `TraceparentInterceptor`: OkHttp interceptor injecting the W3C `traceparent` header on outbound requests (active OTel span → scope trace context; no-op otherwise)
